...
import marbleBg from '../assets/finance-marble-bg.png'
import financeBanner from '../assets/finance-man-graphs.png'
import financeGlasses from '../assets/finance-glasses-glowing.png'
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 lg:px-24">
        ...
        >
          <motion.img 
            src={financeBanner}
            alt="Businessman analyzing holographic financial graphs"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          >
            <div className="relative p-2 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 backdrop-blur-sm overflow-hidden shadow-2xl shadow-black/50">
               <img 
                 src={financeGlasses} 
                 alt="Glowing smart glasses frame"
                 className="w-full h-auto aspect-square object-cover rounded-xl transition-transform duration-700 group-hover:scale-[1.05]"
               />
          ...
          >
            <p className="text-base md:text-xl lg:text-2xl text-white/70 leading-relaxed md:leading-[1.8] font-light">
              <strong className="text-white font-medium">The cost analysis suggests an initial investment of approximately $50,000,</strong> while the projected retail price is expected to range from $25 to $50 per unit. Estimated revenue is around <strong className="text-white font-medium">$200,000,</strong> depending on market response and sales performance.
              <br/><br/>
              With this pricing approach, the product can remain accessible to Vietnam's young consumer market while still offering added value through its smart and customizable design.
            </p>
          </motion.div>
